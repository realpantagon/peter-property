...
export default function ContactUs() {
  return (
    <div className="rounded-[28px] border border-white/10 bg-white/5 px-8 py-10 text-white shadow-2xl backdrop-blur-xl transition-transform hover:scale-[1.01]">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        ...
        <div className="flex-1 space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2">
            <a href="tel:0895555927" className="group flex items-center gap-4 rounded-2xl bg-[#1a1614] p-4 transition-all hover:bg-[#251f1c] hover:shadow-lg hover:shadow-amber-900/10 active:scale-[0.98]">
            ...
            <a href="tel:0614296398" className="group flex items-center gap-4 rounded-2xl bg-[#1a1614] p-4 transition-all hover:bg-[#251f1c] hover:shadow-lg hover:shadow-amber-900/10 active:scale-[0.98]">
              <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-[#b88a3a]/10 text-lg sm:text-2xl group-hover:bg-[#b88a3a]/20 group-hover:scale-110 transition-all">📞</div>
              <div>
          ...
          <div className="grid gap-3 sm:gap-4">
            <a
              ...
              className="group flex items-center gap-4 rounded-2xl bg-[#06c755]/10 p-4 border border-[#06c755]/20 transition-all hover:bg-[#06c755]/20 active:scale-[0.98]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-4 rounded-2xl bg-[#1877F2]/10 p-4 border border-[#1877F2]/20 transition-all hover:bg-[#1877F2]/20 active:scale-[0.98]"
            >
              <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full transition-all group-hover:scale-110">
                <Image
